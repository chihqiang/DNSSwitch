    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            className="bg-transparent border-none text-xl text-text-muted cursor-pointer p-1 leading-none rounded hover:bg-border/30 hover:text-text-primary transition-colors duration-150"
            onClick={onClose}
